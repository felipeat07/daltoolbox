...
<!-- badges: start -->
![GitHub Repo stars](https://img.shields.io/github/stars/cefet-rj-dal/dal?logo=Github)
<!-- badges: end -->
...
You can install the development version of dal from [GitHub](https://github.com/) with:
